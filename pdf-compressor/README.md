...
GitHub will host the tarball at `https://github.com/YOUR_USER/pdf-compressor/archive/refs/tags/v0.1.0.tar.gz`.
...
The repo must be named `homebrew-<tap-name>`, e.g. `homebrew-pdf-compressor`:

```bash
# On GitHub: create the repo `homebrew-pdf-compressor`
