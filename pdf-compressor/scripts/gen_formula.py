...
Usage:
    ...
    python3 scripts/gen_formula.py \
        --source-url https://github.com/YOU/pdf-compressor/archive/refs/tags/v0.1.0.tar.gz \
        --source-sha256 <SHA>
...
def main() -> int:
    ...
    ap.add_argument(
        "--source-url",
        default="https://github.com/YOUR_USER/pdf-compressor/archive/refs/tags/v0.1.0.tar.gz",
  ...
  homepage "https://github.com/YOUR_USER/pdf-compressor"
  url "{args.source_url}"
